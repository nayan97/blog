 ...
 */
    ...
    Route::get ('/service', [ FrontendPageController::class, 'showServicePage']) -> name('servicess.page');
    Route::get ('/about', [ FrontendPageController::class, 'showAboutPage']) -> name('about.page');
